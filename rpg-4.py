# in parent class add method called status applied to parent class return string "Gobling/hero have %d health and %d power"
...
print("ARE THE CHARACTERS ALIVE?")
print(hiro.is_alive())
print(spike.is_alive())
